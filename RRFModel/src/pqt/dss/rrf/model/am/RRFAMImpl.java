...
import pqt.dss.rrf.model.am.common.RRFAM;
import pqt.dss.rrf.model.vo.DssReinstatementRequestFormViewImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Fri Jun 17 11:53:03 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class RRFAMImpl extends ApplicationModuleImpl implements RRFAM {
    /**
    ...
    /**
     * Container's getter for DssReinstatementRequestFormView1.
     * @return DssReinstatementRequestFormView1
     */
    public DssReinstatementRequestFormViewImpl getDssReinstatementRequestFormView1() {
        return (DssReinstatementRequestFormViewImpl) findViewObject("DssReinstatementRequestFormView1");
    }
    ...
    public void callWorkflow(Number p_document_id, String ApprovalType) {
        ...
        String p_notification_message = "Approval Required for Reinstatement Request Form.", p_status = null;
        ...
        if (WfVO.getRowCount() == 0) {
            ...
            try {
                ...
                if (vNotifId != null) {
                    if ("BRANCH".equalsIgnoreCase(ApprovalType)) {
                        this.getDssReinstatementRequestFormView1().getCurrentRow().setAttribute("BranchStatus",
                                                                                                "INPROCESS");
                        this.getDssReinstatementRequestFormView1().getCurrentRow().setAttribute("BranchNotifIdFk",
                                                                                                vNotifId);
                    } else if ("DSS".equalsIgnoreCase(ApprovalType)) {
                        this.getDssReinstatementRequestFormView1().getCurrentRow().setAttribute("DssStatus",
                                                                                                "INPROCESS");
                        this.getDssReinstatementRequestFormView1().getCurrentRow().setAttribute("DssNotifIdFk",
                                                                            vNotifId);
                    }
                    getDBTransaction().commit();
                }
        ...
        this.getDssReinstatementRequestFormView1().executeQuery();
    }
    ...
    /**
     * Container's getter for DssReinstatementExistMgrView1.
     * @return DssReinstatementExistMgrView1
     */
    public ViewObjectImpl getDssReinstatementExistMgrView1() {
        return (ViewObjectImpl) findViewObject("DssReinstatementExistMgrView1");
    }

    /**
     * Container's getter for DssHeadToMgr1.
     * @return DssHeadToMgr1
     */
    public ViewLinkImpl getDssHeadToMgr1() {
        return (ViewLinkImpl) findViewLink("DssHeadToMgr1");
    }

    /**
     * Container's getter for DssReinstatementNewHiringView1.
     * @return DssReinstatementNewHiringView1
     */
    public ViewObjectImpl getDssReinstatementNewHiringView1() {
        return (ViewObjectImpl) findViewObject("DssReinstatementNewHiringView1");
    }

    /**
     * Container's getter for DssHeadToNewHiring1.
     * @return DssHeadToNewHiring1
     */
    public ViewLinkImpl getDssHeadToNewHiring1() {
        return (ViewLinkImpl) findViewLink("DssHeadToNewHiring1");
    }
    public void callRRFWorkflow(Number p_document_id) {
            ...
            callableStatement =
                (OracleCallableStatement) txn.createCallableStatement("BEGIN dss_all_pkg.CALL_RRF_WORKFLOW(:1, :2, :3); END;",
                                                                      DBTransaction.DEFAULT);
